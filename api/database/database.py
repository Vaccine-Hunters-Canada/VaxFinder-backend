...
class MSSQLBackend(DatabaseBackend):
    def __init__(
        ...
        pyodbc: typing.Any = importlib.import_module(f'sqlalchemy.dialects.{self._database_url.driver}.pyodbc')
...
class MSSQLConnection(ConnectionBackend):
    ...
    def _compile(self, query: str) -> typing.Tuple[str, typing.List, CompilationContext]:
